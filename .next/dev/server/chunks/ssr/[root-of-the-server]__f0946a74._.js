    ...
    const handleVideoUpload = async (e)=>{
        ...
        for(let i = 0; i < files.length; i++){
            ...
            try {
                ...
                const { data: uploadData, error: uploadError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('videos').upload(videoPath, file, {
                ...
                const { data: videoPublic } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('videos').getPublicUrl(videoPath);
                // Generate thumbnail
                let thumbnailUrl = '';
                try {
                    const thumbnailBlob = await generateThumbnail(file);
                    const thumbnailPath = `${memorialId}/thumbnails/${videoUuid}.png`;
                    const { error: thumbError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('videos').upload(thumbnailPath, thumbnailBlob, {
                        contentType: 'image/png',
                        upsert: false
                    });
                    if (!thumbError) {
                        const { data: thumbPublic } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('videos').getPublicUrl(thumbnailPath);
    ...
    const removeVideo = async (id)=>{
        ...
        if (video && memorialId) {
            ...
            try {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('videos').remove([
                    `${videoPath}.mp4`,
                    `${videoPath}.mov`,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f0946a74._.js.map