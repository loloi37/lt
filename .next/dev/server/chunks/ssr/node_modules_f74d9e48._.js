...
function fe(e, t) {
    return Array.from(t).sort(e === "horizontal" ? it : rt);
}
function it(e, t) {
...
function st({ orientation: e, rects: t, targetRect: n }) {
    const o = {
        x: n.x + n.width / 2,
        y: n.y + n.height / 2
    };
...
function He(e) {
    const { element: t, orientation: n, panels: o, separators: i } = e, s = fe(n, Array.from(t.children).filter(Fe).map((z)=>({
            element: z
        }))).map(({ element: z })=>z), l = [];
    let r = !1, a = !1, f = !1, u, m = [];
    for (const z of s)if (z.hasAttribute("data-panel")) {
        z.ariaDisabled !== null && (r = !0);
        const S = o.find((c)=>c.element === z);
        if (S) {
            if (u) {
                const c = u.element.getBoundingClientRect(), d = z.getBoundingClientRect();
                let p;
                if (f) {
                    const y = n === "horizontal" ? new DOMRect(c.right, c.top, 0, c.height) : new DOMRect(c.left, c.bottom, c.width, 0), h = n === "horizontal" ? new DOMRect(d.left, d.top, 0, d.height) : new DOMRect(d.left, d.top, d.width, 0);
                    switch(m.length){
                        case 0:
                            {
                                p = [
                    ...
                    n === "horizontal" ? new DOMRect(c.right, d.top, d.left - c.right, d.height) : new DOMRect(d.left, c.bottom, d.width, d.top - c.bottom)
                ];
                for (const y of p){
                    ...
                    if (h.width < v) {
                        const x = v - h.width;
                        h = new DOMRect(h.x - x / 2, h.y, h.width + x, h.height);
                    }
                    if (h.height < v) {
                        const x = v - h.height;
                        h = new DOMRect(h.x, h.y - x / 2, h.width, h.height + x);
                    }
                    const g = !("width" in y);
                    l.push({
                        disabled: a || r && !g,
    ...
    return D = {
        ...
        o.derivedPanelConstraints.forEach((s)=>{
            if (s.collapsible) {
                ...
                if (l) {
                    const r = M(s.collapsedSize, o.layout[s.panelId]), a = M(s.collapsedSize, l[s.panelId]);
...
function gt(e, t) {
    ...
    b(o, "Stacking order can only be calculated for elements with a common ancestor");
    const i = {
        a: ze(ve(n.a)),
        b: ze(ve(n.b))
    };
...
function xt({ groupElement: e, hitRegion: t, pointerEventTarget: n }) {
    if (!Fe(n) || n.contains(e) || e.contains(n)) return !0;
    if (gt(n, e) > 0) {
        let o = n;
        for(; o;){
            if (o.contains(e)) return !0;
            if (zt(o.getBoundingClientRect(), t)) return !1;
            o = o.parentElement;
        }
    }
    return !0;
...
function U({ panelConstraints: e, prevSize: t, size: n }) {
    const { collapsedSize: o = 0, collapsible: i, disabled: s, maxSize: l = 100, minSize: r = 0 } = e;
    if (s) return t;
    if (T(n, r) < 0) if (i) {
        const a = (o + r) / 2;
        T(n, a) < 0 ? n = o : n = r;
...
function Q({ delta: e, initialLayout: t, panelConstraints: n, pivotIndices: o, prevLayout: i, trigger: s }) {
    if (M(e, 0)) return t;
    const l = Object.values(t), r = Object.values(i), a = [
        ...l
    ], [f, u] = o;
            ...
            {
                {
                    ...
                    b(d, `Panel constraints not found for index ${c}`);
                    const { collapsedSize: p = 0, collapsible: y, minSize: h = 0 } = d;
                    if (y) {
                        const v = l[c];
                        if (b(v != null, `Previous layout not found for panel index ${c}`), M(v, p)) {
                            const g = h - v;
                ...
                }
                {
                    ...
                    b(d, `No panel constraints found for index ${c}`);
                    const { collapsedSize: p = 0, collapsible: y, minSize: h = 0 } = d;
                    if (y) {
                        const v = l[c];
                        if (b(v != null, `Previous layout not found for panel index ${c}`), M(v, h)) {
                            const g = v - p;
                            T(g, Math.abs(e)) > 0 && (e = e < 0 ? 0 - g : g);
                        }
                    }
    ...
    }
    {
        ...
        for(;;){
            const h = l[d];
            b(h != null, `Previous layout not found for panel index ${d}`);
            const g = U({
                panelConstraints: n[d],
                prevSize: h,
                size: 100
            }) - h;
            if (p += g, d += c, d < 0 || d >= n.length) break;
        }
    ...
    }
    {
        ...
        for(; d >= 0 && d < n.length;){
            ...
            b(y != null, `Previous layout not found for panel index ${d}`);
            const h = y - p, v = U({
                panelConstraints: n[d],
                prevSize: y,
                size: h
    ...
    if (bt(r, a)) return i;
    {
        ...
        b(d != null, `Previous layout not found for panel index ${c}`);
        const p = d + m, y = U({
        ...
        if (a[c] = y, !M(y, p)) {
            ...
            for(; g >= 0 && g < n.length;){
                const x = a[g];
                b(x != null, `Previous layout not found for panel index ${g}`);
                const C = x + h, L = U({
                    panelConstraints: n[g],
                    prevSize: x,
                    size: C
                });
                if (M(x, L) || (h -= L - x, a[g] = L), M(h, 0)) break;
                e > 0 ? g-- : g++;
            }
        }
    }
    const z = Object.values(a).reduce((c, d)=>d + c, 0);
    if (!M(z, 100, 0.1)) return i;
    const S = Object.keys(i);
    return a.reduce((c, d, p)=>(c[S[p]] = d, c), {});
}
function $(e, t) {
    if (Object.keys(e).length !== Object.keys(t).length) return !1;
    for(const n in e)if (t[n] === void 0 || T(e[n], t[n]) !== 0) return !1;
    return !0;
}
function H({ layout: e, panelConstraints: t }) {
    ...
    if (!M(i, 100) && o.length > 0) for(let r = 0; r < t.length; r++){
        const a = o[r];
    ...
    if (!M(s, 0)) for(let r = 0; r < t.length; r++){
        const a = o[r];
        b(a != null, `No layout data found for index ${r}`);
        const f = a + s, u = U({
            panelConstraints: t[r],
        ...
        if (a !== u && (s -= u - a, o[r] = u, M(s, 0))) break;
    }
    const l = Object.keys(e);
    return o.reduce((r, a, f)=>(r[l[f]] = a, r), {});
}
function Ve({ groupId: e, panelId: t }) {
    const n = ()=>{
        const { mountedGroups: r } = G();
        for (const [a, { defaultLayoutDeferred: f, derivedPanelConstraints: u, layout: m, separatorToPanels: z }] of r)if (a.id === e) return {
        ...
        const a = s();
        if (r === a) return;
        const { defaultLayoutDeferred: f, derivedPanelConstraints: u, group: m, layout: z, separatorToPanels: S } = n(), c = m.panels.findIndex((h)=>h.id === t), d = c === m.panels.length - 1, p = Q({
            delta: d ? a - r : r - a,
            initialLayout: z,
            panelConstraints: u,
            pivotIndices: d ? [
...
function We({ groupId: e }) {
    ...
    return {
        ...
        setLayout (n) {
            const { defaultLayoutDeferred: o, derivedPanelConstraints: i, group: s, layout: l, separatorToPanels: r } = t(), a = H({
                layout: n,
                panelConstraints: i
            });
            if (o) return l;
...
function F(e, t) {
    const n = ae(e), o = Ue(n), i = n.separators.find((m)=>m.element === e);
    b(i, "Matching separator not found");
    const s = o.separatorToPanels.get(i);
    b(s, "Matching panels not found");
    const l = s.map((m)=>n.panels.indexOf(m)), a = We({
        groupId: n.id
    }).getLayout(), f = Q({
        delta: t,
        initialLayout: a,
...
function we(e) {
    ...
    if (!n.disabled) switch(e.key){
        ...
        case "Enter":
            {
                e.preventDefault();
                const o = ae(t), { derivedPanelConstraints: i, layout: s, separatorToPanels: l } = Ue(o), r = o.separators.find((m)=>m.element === t);
                b(r, "Matching separator not found");
                const a = l.get(r);
                b(a, "Matching panels not found");
                const f = a[0], u = i.find((m)=>m.panelId === f.id);
        ...
        case "F6":
            {
                e.preventDefault();
                const i = ae(t).separators.map((a)=>a.element), s = Array.from(i).findIndex((a)=>a === e.currentTarget);
...
const wt = (e)=>e, ue = ()=>{}, Be = 1, Ke = 2, Xe = 4, qe = 8, Ce = 3, Pe = 12;
let se;
function Re() {
    return se === void 0 && (se = !1, ("TURBOPACK compile-time value", "undefined") < "u" && (window.navigator.userAgent.includes("Chrome") || window.navigator.userAgent.includes("Firefox")) && (se = !0)), se;
}
function Lt({ cursorFlags: e, groups: t, state: n }) {
    let o = 0, i = 0;
    switch(n){
        case "active":
        case "hover":
...
function Ye({ document: e, event: t, hitRegions: n, initialLayoutMap: o, mountedGroups: i, pointerDownAtPoint: s, prevCursorFlags: l }) {
    let r = 0;
    const a = new Map(i);
    n.forEach((u)=>{
        ...
        const y = o.get(m), { defaultLayoutDeferred: h, derivedPanelConstraints: v, layout: g, separatorToPanels: x } = i.get(m) ?? {
        ...
        case "active":
            {
                ...
                e.buttons === 0) {
                    E((i)=>i.interactionState.state === "inactive" ? i : {
                            cursorFlags: 0,
                            interactionState: {
                                state: "inactive"
                            }
...
function Mt(e) {
    let t = !0;
    b(e.element.ownerDocument.defaultView, "Cannot register an unmounted Group");
                ...
                if (t) {
                    ...
                    E((v)=>{
                        ...
                        if (g) {
                            ...
                            return !g.defaultLayoutDeferred && $(C, L) && Pt(g.derivedPanelConstraints, x) ? v : {
    ...
    s.observe(e.element), e.panels.forEach((c)=>{
        b(!o.has(c.id), `Panel ids must be unique; id "${c.id}" was used more than once`), o.add(c.id), c.onResize && s.observe(c.element);
    });
    const l = B({
        group: e
    }), r = Se(e), a = e.panels.map(({ id: c })=>c).join(",");
    ...
    return E((c)=>{
        ...
        return W.set(S, (W.get(S) ?? 0) + 1), z.forEach((p)=>{
        ...
        b(!i.has(c.id), `Separator ids must be unique; id "${c.id}" was used more than once`), i.add(c.id), c.element.addEventListener("keydown", we);
        ...
        t = !1, W.set(S, Math.max(0, (W.get(S) ?? 0) - 1)), E((d)=>{
        ...
        }), W.get(S) || (S.removeEventListener("dblclick", be, !0), S.removeEventListener("pointerdown", Le, !0), S.removeEventListener("pointerleave", Ee), S.removeEventListener("pointermove", ke), S.removeEventListener("pointerout", Ge), S.removeEventListener("pointerup", Ie, !0)), s.disconnect();
    };
}
function Et() {
...
function Gt(e, t) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useImperativeHandle"])(t, ()=>n.current, []), j(()=>{
        Object.assign(n.current, We({
            groupId: e
        }));
    });
}
function It({ children: e, className: t, defaultLayout: n, disableCursor: o, disabled: i, elementRef: s, groupRef: l, id: r, onLayoutChange: a, onLayoutChanged: f, orientation: u = "horizontal", resizeTargetMinimumSize: m = {
    coarse: 20,
    fine: 10
}, style: z, ...S }) {
    ...
    }), y = me(r), h = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null), [v, g] = Et(), x = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])({
    ...
    const L = Y((w, P)=>{
        ...
        for (const ee of V.keys())if (ee.id === w) {
            const K = V.get(ee);
            if (K) {
                let te = !1;
                switch(k.state){
                    case "active":
                        {
                            te = k.hitRegions.some((le)=>le.group === ee);
                            break;
                        }
                }
                return {
        ...
        return {
            ...
            registerPanel: (w)=>{
                ...
                return P.panels = fe(u, [
                    ...
                    P.panels = P.panels.filter((k)=>k !== w), g();
                };
            },
            registerSeparator: (w)=>{
                const P = x.current;
                return P.separators = fe(u, [
                    ...
                    P.separators = P.separators.filter((k)=>k !== w), g();
                };
            }
        }), [
        L,
        ...
        defaultLayout: n,
        disableCursor: o
    }), A = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    return j(()=>{
        const w = h.current;
        if (w === null) return;
        const P = x.current, k = {
        ...
        const te = N.addListener("interactionStateChange", (X)=>{
            X.state;
        }), le = N.addListener("mountedGroupsChange", (X)=>{
            const ne = X.get(k);
            if (ne) {
                const { defaultLayoutDeferred: oe, derivedPanelConstraints: Ze, layout: ye } = ne;
                if (oe || Ze.length === 0) return;
    ...
    }), /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])(Je.Provider, {
        value: R,
...
function Ht({ debounceSaveMs: e = 100, panelIds: t, storage: n = localStorage, ...o }) {
    const i = t !== void 0, s = "id" in o ? o.id : o.groupId, l = ce(s, t ?? []), r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSyncExternalStore"])(Dt, ()=>n.getItem(l), ()=>n.getItem(l)), a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>r ? JSON.parse(r) : void 0, [
        r
    ...
    const m = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((S)=>{
        u();
        let c;
        ...
        s,
        n
    ]), z = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((S)=>{
...
function ge() {
    ...
    return b(e, "Group Context not found; did you render a Panel or Separator outside of a Group?"), e;
}
function Ot(e, t) {
    const { id: n } = ge(), o = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])({
        collapse: ue,
        expand: ue,
        getSize: ()=>({
                asPercentage: 0,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useImperativeHandle"])(t, ()=>o.current, []), j(()=>{
        Object.assign(o.current, Ve({
            groupId: n,
            panelId: e
        }));
    });
}
function Tt({ children: e, className: t, collapsedSize: n = "0%", collapsible: o = !1, defaultSize: i, disabled: s, elementRef: l, id: r, maxSize: a = "100%", minSize: f = "0%", onResize: u, panelRef: m, style: z, ...S }) {
    const c = !!r, d = me(r), p = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null), y = he(p, l), { getPanelStyles: h, id: v, registerPanel: g } = ge(), x = u !== null, C = Y((R, _, A)=>{
        u?.(R, r, A);
    });
    j(()=>{
        const R = p.current;
    ...
    const L = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSyncExternalStore"])((R)=>(N.addListener("mountedGroupsChange", R), ()=>{
    ...
    ()=>JSON.stringify(h(v, d)), ()=>JSON.stringify(h(v, d)));
...
function _t({ layout: e, panelConstraints: t, panelId: n, panelIndex: o }) {
    ...
    if (r) {
        const a = r.maxSize, f = r.collapsible ? r.collapsedSize : r.minSize, u = [
            o,
            o + 1
        ];
        s = H({
...
function At({ children: e, className: t, disabled: n, elementRef: o, id: i, style: s, ...l }) {
    const r = me(i), [a, f] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({}), [u, m] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("inactive"), z = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null), S = he(z, o), { id: c, orientation: d, registerSeparator: p } = ge(), y = d === "horizontal" ? "vertical" : "horizontal";
    return j(()=>{
        const h = z.current;
        if (h !== null) {
            const v = {
                ...
                element: h,
                id: r
            }, g = p(v), x = N.addListener("interactionStateChange", (L)=>{
                m(L.state !== "inactive" && L.hitRegions.some((R)=>R.separator === v) ? L.state : "inactive");
            }), C = N.addListener("mountedGroupsChange", (L)=>{
                L.forEach(({ derivedPanelConstraints: R, layout: _, separatorToPanels: A }, w)=>{
                    if (w.id === c) {
                        const P = A.get(v);
                        if (P) {
...
//# sourceMappingURL=node_modules_f74d9e48._.js.map