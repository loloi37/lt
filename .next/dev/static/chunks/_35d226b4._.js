...
"[project]/components/wizard/Step9Review.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(Step9Review, "nBSdJIvKqVmkk+vpGBERQ3hToz0=");
_c = Step9Review;
var _c;
__turbopack_context__.k.register(_c, "Step9Review");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
_s(Step9Videos, "0CLVWOVx+8g0ODBjgEMJWUwEryM=");
_c = Step9Videos;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$wizard$2f$Step9Review$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/wizard/Step9Review.tsx [app-client] (ecmascript)");
...
function CreateMemorialPageContent() {
    ...
    const loadMemorial = async (id)=>{
        setIsLoading(true);
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('memorials').select('*').eq('id', id).single();
    ...
    const saveToSupabase = async ()=>{
        ...
        try {
            ...
            if (currentMemorialId) {
                const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('memorials').update(memorialRecord).eq('id', currentMemorialId);
                if (error) throw error;
            } else {
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('memorials').insert([
                    memorialRecord
                ]).select().single();
                if (error) throw error;
                if (data) {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    memorialData.currentStep === 10 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$wizard$2f$Step9Review$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        data: memorialData,
                        onBack: goToPreviousStep,
...
_s(CreateMemorialPageContent, "qEXuCnanV7RpP/OxwG8yzS5xKCc=", false, function() {
    return [
...
//# sourceMappingURL=_35d226b4._.js.map