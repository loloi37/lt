    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PaymentSuccessContent.useEffect": ()=>{
            const finalizePayment = {
                "PaymentSuccessContent.useEffect.finalizePayment": async ()=>{
                    ...
                    try {
                        ...
                        setTimeout({
                            "PaymentSuccessContent.useEffect.finalizePayment": ()=>{
                                router.push(`/create?id=${memorialId}`);
                            }
                        }["PaymentSuccessContent.useEffect.finalizePayment"], 3000);
                    } catch (err) {
...
//# sourceMappingURL=_de9309eb._.js.map