    ...
    return (
      ...
      from-mist/10 via-ivory to-stone/10">
        ...
        py-16 flex flex-col items-center">
          ...
          text-charcoal text-center mb-2">
                    {memorial.fullName}
                </h1>
                {dateRange && (
          ...
          overflow-hidden mb-8">
            ...
            border-t border-sand/20">
                    <div className="px-8 py-6 
              border-r border-sand/20">
                        <h3 className="text-xs font-semibold 
                text-charcoal/50 uppercase 
            ...
            <button
                onClick={onContinue}
                className="w-full py-4 bg-charcoal 
            hover:bg-charcoal/90 text-ivory 
            rounded-xl font-medium transition-all 
            shadow-lg mb-4 btn-paper"
            >
                Continue to join this archive →
            </button>

            {/* Reassurance microcopy */}
            <p className="text-xs text-charcoal/30 text-center leading-relaxed">
