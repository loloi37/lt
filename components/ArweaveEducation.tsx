...
export default function ArweaveEducation() {
    ...
    return (
        <div className="bg-surface-mid rounded-xl border border-warm-border overflow-hidden">
            <button
                onClick={() => setExpanded(!expanded)}
                className="w-full flex items-center justify-between p-5 text-left"
            >
                <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-surface-high rounded-lg flex items-center justify-center">
                        <Globe size={16} className="text-warm-muted" />
                    </div>
                    <span className="text-sm font-sans font-medium text-warm-dark">
                        What is Arweave? Learn more
                    </span>
                </div>
                <ChevronDown
                    size={16}
                    className={`text-warm-muted transition-transform ${expanded ? 'rotate-180' : ''}`}
                />
            </button>
                ...
                <div className="px-5 pb-5 pt-0 space-y-5 animate-fade-in-up">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-surface-high/50 rounded-lg p-4">
                            <Server size={18} className="text-warm-muted mb-2" />
                            <h4 className="text-sm font-sans font-medium text-warm-dark mb-1">847 Nodes</h4>
                        ...
                        <div className="bg-surface-high/50 rounded-lg p-4">
                            <Clock size={18} className="text-warm-muted mb-2" />
                            <h4 className="text-sm font-sans font-medium text-warm-dark mb-1">200-Year Endowment</h4>
                            <p className="text-xs text-warm-muted font-sans">
                        ...
                        <div className="bg-surface-high/50 rounded-lg p-4">
                            <Shield size={18} className="text-warm-muted mb-2" />
                            <h4 className="text-sm font-sans font-medium text-warm-dark mb-1">Immutable</h4>
                            <p className="text-xs text-warm-muted font-sans">
                        ...
                        <div className="bg-surface-high/50 rounded-lg p-4">
                            <Globe size={18} className="text-warm-muted mb-2" />
                            <h4 className="text-sm font-sans font-medium text-warm-dark mb-1">Multi-Gateway</h4>
                            <p className="text-xs text-warm-muted font-sans">
                    ...
                    <div className="bg-surface-high/30 rounded-lg p-4 border border-warm-border">
                        <h4 className="text-sm font-sans font-medium text-warm-dark mb-2">
